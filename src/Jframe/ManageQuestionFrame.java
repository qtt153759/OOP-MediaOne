 ...
 * @author admin
 */
public class ManageQuestionFrame extends javax.swing.JFrame {

    /**
     * Creates new form quanlymonhoc
     */
    AddNewQuestion addQuestionPanel;
    List<JPanel> tmpPanel;
    List<JLabel> tmpLabel;

    public ManageQuestionFrame() {
        initComponents();
        ...
        this.addQuestionPanel = new AddNewQuestion(this);
        this.addQuestionPanel.setSize(700,700);
        this.addQuestionPanel.setVisible(true);
        this.current.add(this.addQuestionPanel);
    }
    
    public void setCurrentPanel(java.awt.event.MouseEvent evt, Question question) {
        System.out.println("check before" + this.current.getComponents().length);
        this.current.setVisible(false);
        this.current.removeAll();
        QuestionPanel questionPanel = new QuestionPanel(this,question);
        questionPanel.setSize(700, 700);
        questionPanel.setVisible(true);
        this.current.add(questionPanel);
    ...
    public void createQuestionList() {
        jPanel2.removeAll();
        for (int i = 0; i < ManageQuestion.questionList.size(); i++) {
            JPanel panel = new JPanel();
            final Question selectedQuestion = ManageQuestion.questionList.get(i);
            panel.addMouseListener(new java.awt.event.MouseAdapter() {
                public void mouseClicked(java.awt.event.MouseEvent evt) {
                    setCurrentPanel(evt, selectedQuestion);
                }
            });
            renderQuestionList(ManageQuestion.questionList.get(i), panel);
        }
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Danh sách câu hỏi");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(current, javax.swing.GroupLayout.PREFERRED_SIZE, 709, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(current, javax.swing.GroupLayout.DEFAULT_SIZE, 461, Short.MAX_VALUE)
    ...
    public void createAddQuestionForm() {
        this.current.setVisible(false);
        this.current.removeAll();
        this.addQuestionPanel = new AddNewQuestion(this);
        this.addQuestionPanel.setSize(700, 700);
        this.addQuestionPanel.setVisible(true);
        this.current.add(addQuestionPanel);
        this.current.setVisible(true);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageQuestionFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageQuestionFrame().setVisible(true);
            }
        });
    }
